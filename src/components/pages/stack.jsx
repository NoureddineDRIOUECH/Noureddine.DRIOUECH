...
export function Stack() {
  return (
    <div className='my-28 w-[90%] mx-auto'>
      ...
      <div className="flex rounded-[30px] dark:border-[#6C6C6C] border-cyan-500 shadow-2xl p-5 md:p-10 xl:flex-row md:flex-col flex-col lg:flex-col md:w-[75%] w-full justify-center gap-8 md:gap-10  text-center m-auto items-center">
